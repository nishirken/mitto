...
E-ink optimized Telegram web client. Lit web components, TypeScript, Vite, pnpm. TDLib WASM via `@dibgram/tdweb` for Telegram API. Vitest + Playwright for browser testing. ESLint + Stylelint for linting. Nix flake + direnv for dev environment.
